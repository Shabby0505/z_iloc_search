		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ILOC Search",
									"targetURL": "#comilocsearchzilocsearch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comilocsearchzilocsearch-display": {
								"semanticObject": "comilocsearchzilocsearch",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.iloc.search.zilocsearch",
									"url": sap.ui.require.toUrl("com/iloc/search/zilocsearch")
								}
							}
						}
					}
